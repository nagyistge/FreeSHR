...
import static org.freeshr.application.fhir.ValidationErrorType.CODE_UNKNOWN;
...
public class ResourceValidatorTest {
    ...
    public void shouldVerifyThatEveryCodeableConceptInAConditionIsCoded() {
        ...
        assertThat(messages.get(0).getType(), is(CODE_UNKNOWN));
        ...
        assertThat(messages.get(1).getType(), is(CODE_UNKNOWN));
        ...
        assertThat(messages.get(2).getType(), is(CODE_UNKNOWN));
    }

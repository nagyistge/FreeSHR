...
public class EncounterValidatorIntegrationTest {
    ...
    public void shouldValidateRouteInMedicationPrescription() {
        ...
        verify(trConceptLocator, times(1)).validateCode("http://localhost:9997/openmrs/ws/rest/v1/tr/vs/Route-of-Administration", "implant",
                "implant");
        assertTrue(response.isSuccessful());
    }
    ...
    public void shouldValidateSiteAndReasonInMedicationPrescription() {
        ...
        validationContext = new EncounterValidationContext(encounterBundle, new BundleDeserializer());
        EncounterValidationResponse response = validator.validate(validationContext);
        verify(trConceptLocator, times(1)).validateCode("http://172.18.46.56:9080/openmrs/ws/rest/v1/tr/vs/dosageInstruction-site",
                "181220002", "Entire oral cavity");
        verify(trConceptLocator, times(1)).validateCode("http://172.18.46.56:9080/openmrs/ws/rest/v1/tr/vs/prescription-reason", "38341003",
                "High blood pressure");
        assertTrue(response.isSuccessful());
    ...
    public void shouldValidateSubstitutionTypeAndReasonInMedicationPrescription() {
        ...
        validationContext = new EncounterValidationContext(encounterBundle, new BundleDeserializer());
        EncounterValidationResponse response = validator.validate(validationContext);
        verify(trConceptLocator, times(1)).validateCode("http://172.18.46.56:9080/openmrs/ws/rest/v1/tr/vs/substitution-type", "291220002",
                "Paracetamol");
    ...
    public void shouldValidateMethodAndAsNeededXInMedicationPrescription() {
        ...
        validationContext = new EncounterValidationContext(encounterBundle, new BundleDeserializer());
        EncounterValidationResponse response = validator.validate(validationContext);
        verify(trConceptLocator, times(1)).validateCode("http://172.18.46" +
    ...
    public void shouldValidateInvalidCodeInDischargeSummaryEncounter() {
        ...
        verify(trConceptLocator, times(5)).validateCode(anyString(), eq("a6e20fe1-4044-4ce7-8440-577f7f814765-invalid"), anyString());

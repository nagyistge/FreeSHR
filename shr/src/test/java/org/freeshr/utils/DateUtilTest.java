...
public class DateUtilTest {
    ...
    public void shouldValidatePeriod() throws Exception {
        Date startDate = DateUtil.parseDate("2014-12-31T00:00:00+05:30");
        Date endDate = DateUtil.parseDate("2014-12-31T00:00:00+05:30");
        assertTrue(isValidPeriod(startDate, endDate));

        startDate = DateUtil.parseDate("2014-12-31T00:00:00+05:30");
        endDate = null;
        assertTrue(isValidPeriod(startDate, endDate));


        startDate = null;
        endDate = DateUtil.parseDate("2014-12-31T00:00:00+05:30");
        assertTrue(isValidPeriod(startDate, endDate));
        ...
        startDate = DateUtil.parseDate("2014-12-31T00:00:00+05:30");
        endDate = DateUtil.parseDate("2014-11-30T00:00:00+05:30");
